...
export class RegisterComponent implements OnInit {
    ...
    constructor(private config: ConfigurationService, private userService: UserService, private fb: FormBuilder, private registerUserService: RegisterUserService ) {
    }
    ...
    getUserWebappProperties() {   
        this.config.appProperties.then((data) => {
